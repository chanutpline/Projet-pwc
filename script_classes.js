...
class Image {
    ...
    constructor(imgPath, dom, position) {
        ...
        //utilise une promesse sur le chargement de l'image et appelle processImage, sinon affiche une erreur
    ...
    processImage() {
        ...
        //récupère la hauteur et largeur de l'image chargée
        this.width = this.img.naturalWidth;
        this.height = this.img.naturalHeight;
        //initialise la hitbox avec la taille récupérée
        this.hitbox = new Hitbox(this.position, this.width, this.height);
    }

    //promesse du chargement de l'image
    loadImage(image) {
